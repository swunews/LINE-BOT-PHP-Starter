...
if ($arrJson['events'][0]['message']['text'] == "สวัสดี" || $arrJson['events'][0]['message']['text'] == "ดี" || $arrJson['events'][0]['message']['text'] == "ดีจ้า" || $arrJson['events'][0]['message']['text'] == "หวัดดี" || $arrJson['events'][0]['message']['text'] == "Hi" || $arrJson['events'][0]['message']['text'] == "Hello")
{
    $arrPostData = array();
...
else if ($arrJson['events'][0]['message']['text'] == "หิวจัง" || $arrJson['events'][0]['message']['text'] == "มีไรกิน" || $arrJson['events'][0]['message']['text'] == "หิว" || $arrJson['events'][0]['message']['text'] == "หิวแล้ว" || $arrJson['events'][0]['message']['text'] == "ของกิน" || $arrJson['events'][0]['message']['text'] == "อาหาร")
{
    $arrPostData = array();
    $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
    $arrPostData['messages'][0]['type'] = "image";
...
else if ($arrJson['events'][0]['message']['text'] == "มศว" || $arrJson['events'][0]['message']['text'] == "swu" || $arrJson['events'][0]['message']['text'] == "ที่อยู่" || $arrJson['events'][0]['message']['text'] == "Location" || $arrJson['events'][0]['message']['text'] == "location")
{
    $arrPostData = array();
    $arrPostData['replyToken'] = $arrJson['events'][0]['replyToken'];
...
else if ($arrJson['events'][0]['message']['text'] == "เข้าสู่ระบบ")
{
    ...
    {
        $arrPostData['message'][0]['type'] = "confirm";
        $arrPostData['message'][0]['text'] = "Are you sure?";
        $arrPostData['message'][0]['actions'] = [
        {
